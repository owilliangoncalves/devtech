...
export default function Fundamentos() {
  ...
  return (
    <>
      <section className='containerResponsive grid grid-cols-10'>
        <div className=' lg:col-start-1'>
          <SideNav />
        </div>
        <div className='col-start-1 lg:col-start-3 col-span-9 justify-center w-full flex flex-col'>
          <Image
            src={Beginning}
          ...
          />
          <StorySet />
          <Titulo titulo='Fundamentos' className='pt-16' />
          <Avatar author='Willian Gonçalves' date='28/06/2024' />
          <div className='lg:grid  gap-3'>
            <div className='col-span-3'>
              <div className=' '>
                ...
                />
                <Posts tituloPosts='Tipo de dados' id='Tipo de dados' />
              </div>
            </div>
          </div>
        </div>
