  ...
  return (
    <div>
      ...
      <p>
        ...
        áreas afins deve ser acessível a todos. Não somos uma escola de
        programação e não estamos aqui para vender cursos, queremos transformar
        a forma como o conhecimento é transmitido e recebido, tornando-o mais
        inclusivo, acessível e livre.
      </p>
      <p>
        Por isso, nos propomos a abordar os mesmos tópicos que você deverá
        ...
        acreditamos que o ambiente universitário está além de aulas acadêmicas,
        ele tem o papel do promover conexões que podem gerar uma boa ideia, além
        do papel na formação social do cidadão.
      </p>
      <p>
        Nosso compromisso é com a didática inclusiva. Buscamos incessantemente
      ...
      <p>
        ...
        didática e deseja contribuir para essa missão, convidamos você a se
        juntar a nós. Sua arte pode ser a ponte que conecta muitos ao
      ...
      <p>
        ...
        estivesse ensinando para alguém que não tem conhecimento prévio no
        assunto. Essa abordagem não apenas facilita a compreensão, mas também
        solidifica o conhecimento e promove uma aprendizagem mais profunda e
        significativa.
      </p>
      <p>
        Junte-se a nós nessa missão e vamos, juntos, democratizar o
        conhecimento. Juntos, podemos fazer a diferença.
      </p>
    </div>
  );
}
