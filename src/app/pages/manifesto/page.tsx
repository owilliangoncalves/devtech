    ...
    <div className='containerResponsive'>
      ...
      <Paragraph
        ...
        texto='um mundo cada vez mais digital, onde a tecnologia desempenha um papel
          ...
          tornando-o mais inclusivo, acessível e livre.'
      />
      <Paragraph
        primeiraPalavra='Por'
        texto='isso, nos propomos a abordar os mesmos tópicos que você deverá
      ...
      <Paragraph
        primeiraPalavra='Se'
        texto='você possui habilidades com ilustração ou acredita ter uma boa didática
      ...
      />
      <Paragraph
        primeiraPalavra='Apoiamos'
        texto='a técnica de estudo desenvolvida por Richard Feynman, que se baseia em
